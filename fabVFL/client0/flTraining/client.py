    ...
    while True:
        ...
        while True:
            ...
            if msg == "MISSION_END":
                ...
                scipy.io.savemat(saveTitle + '_acc' + '.mat', mdict={saveVariableName + 'acc': cv_acc})
                scipy.io.savemat(saveTitle + '_loss' + '.mat', mdict={saveVariableName + 'loss': cv_loss})
                scipy.io.savemat(saveTitle + '_time' + '.mat', mdict={saveVariableName + 'time': cv_time})
                scipy.io.savemat(saveTitle + '_modelTrainTime' + '.mat', mdict={saveVariableName + 'modelTrainTime': modeltrain_time})
                scipy.io.savemat(saveTitle + '_losswaitTime' + '.mat', mdict={saveVariableName + 'losswaitTime': waitloss_time})
                print("mission end")
            ...
            modeltrain_time.append(model_train_time_end - model_train_time_start)

            waitloss_time_start = time.time()
            ...
            waitloss_time_end = time.time()
            waitloss_time.append(waitloss_time_end - waitloss_time_start)
